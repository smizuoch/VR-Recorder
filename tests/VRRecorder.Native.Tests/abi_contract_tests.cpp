...
bool RejectsTruncatedOrInvalidExtendedSessionConfig()
{
    ...
    CHECK(rejected(config));
    config = ValidConfig();
    config.destination_height = 1079;
    CHECK(rejected(config));
    config = ValidConfig();
    config.destination_x = 481;
    CHECK(rejected(config));
    config = ValidConfig();
    config.destination_y = 1'081;
    CHECK(rejected(config));
    config = ValidConfig();
    config.destination_x = 2;
    config.destination_width = 1'920;
    CHECK(rejected(config));
    config = ValidConfig();
    config.destination_y = 2;
    config.destination_height = 1'080;
    CHECK(rejected(config));
    config = ValidConfig();
