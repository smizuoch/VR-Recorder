...
- t-wada式TDD、結合テスト単独で主要assembly／native first-party sourceごとの行・分岐coverage各80%以上
...
- t-wada-style TDD and at least 80% line and branch coverage per major assembly and native first-party source from the integration-test suite alone
