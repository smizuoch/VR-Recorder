...
- native Make ABI／audio pipeline／availability-event／video CFR scheduler contract: 成功
...
- native Make ABI/audio-pipeline/availability-event/video-CFR-scheduler contracts: passed
