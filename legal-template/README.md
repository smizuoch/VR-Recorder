...
- `THIRD-PARTY-COMPONENTS.example.json`: SteamVR／desktop UI用component manifest例
...
- `THIRD-PARTY-COMPONENTS.example.json`: Component manifest for the SteamVR and desktop legal UI
