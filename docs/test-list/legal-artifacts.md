...
- [ ] direct NuGet追加を完全なmetadata／license全文とともにNoticesへ自動追記する
- [ ] transitive NuGet追加もNoticesとSPDX SBOMへ自動追記する
...
- [ ] Add a direct NuGet dependency to Notices with complete metadata and full license text
- [ ] Add a transitive NuGet dependency to both Notices and the SPDX SBOM
