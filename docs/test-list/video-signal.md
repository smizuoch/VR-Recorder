...
- [ ] 黒画素でもfresh frameならAvailableを維持する
- [ ] 1.5秒fresh frameがなければSignalLostへ遷移する
...
- [ ] Keep the signal Available for a fresh black frame
- [ ] Enter SignalLost after 1.5 seconds without a fresh frame
