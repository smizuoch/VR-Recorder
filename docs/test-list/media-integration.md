...
- [ ] nonzero AAC packetとFinish packetを実fragmented MOVへ書き、別processのpinned oracleでAAC-LC／48 kHz／stereo／packet count／bitrate metadataをdemux検証する
...
- [ ] Write nonzero AAC and Finish packets into a real fragmented MOV and use a separately pinned process oracle to demux-check AAC-LC, 48 kHz, stereo, packet count, and bitrate metadata
