...
- [ ] 48,000 input frameに対するAAC decoded frame完全一致を別processのpinned oracleで検証し、末尾paddingを残さない
...
- [ ] Verify exact AAC decoded-frame equality for 48,000 input frames with the separately pinned process oracle, leaving no tail padding
