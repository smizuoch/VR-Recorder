...
1. production SDKと同じFFmpeg 8.1.2 source identityからtest-onlyの別process demux／decode oracleを再現buildし、AACのdecoded frame数を固定する。oracleをproduction payloadへ混ぜない。
